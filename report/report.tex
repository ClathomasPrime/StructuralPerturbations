...
\section{Related Work}
  ...
  \subsection{Continuity and Lipschitz Robustness}
    \noindent{\it Continuity}\space\space Hamlet \cite{hamlet02} considered the
    ...
    \noindent{\it Lipschitz Robustness}\space\space Robustness for control systems was
  ...
  \subsection{$k$-Safety Properties}
    ...
    \noindent{\(k\)-Safety Properties}\space\space Clarkson and Schneider
