...
%   \begin{minipage}[c][2cm][c]{\dimexpr0.6\textwidth-0.5\Colsep\relax}
%   \end{minipage}\hfill
%   \noindent\begin{minipage}{0.4\textwidth}
%     \begin{minipage}[c][6cm][c]{\dimexpr0.19\textwidth}
%       \qroofx=2
%       \qroofy=1
%       \Tree [.b [.a \qroof{LL}. \qroof{LR}. ] \qroof{R}. ]
%     \end{minipage}\hfill
%     \begin{minipage}[c][6cm][c]{\dimexpr0.02\textwidth}
%       $\xmapsto{\mathrm{\ \ \rho\ \ }}$
%     \end{minipage}\hfill
%     \begin{minipage}[c][6cm][c]{\dimexpr0.19\textwidth}
%       \qroofx=2
...
(intuitively thought of as a rotation)(intuitively thought of a
