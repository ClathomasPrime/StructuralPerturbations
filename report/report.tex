...
\vspace{-0.05in}
  ...
  then nearly every function written on this data type should be class invariant with
  respect to the $\mathrm{list}$ function,
  because these data types are meant to represent the lists
  (while allowing for faster algorithms).
